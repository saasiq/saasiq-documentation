...
|:--:|:--:|:--:|:--:|
| Total Apps | Monthly $ | Savings | Utilization |

**📈 Charts:** Spend Trend (line) &nbsp; + &nbsp; Category Split (donut)

**⚠️ Urgent Actions** — Critical items needing immediate attention

**📅 Renewals Table** &nbsp; + &nbsp; **📊 Top Apps by Spend**
