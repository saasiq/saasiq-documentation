...
```mermaid
graph LR
    A["📊 Your Data"] --> B["🤖 SaaSIQ AI Engine"]
    B --> C["💡 AI Insights<br/>Push notifications"]
    B --> D["💬 AI Copilot<br/>Ask questions"]
    C --> E["Apply / Review / Dismiss"]
    D --> F["Tables, Charts, Recommendations"]
```
